...
public class BlockPistonStructureHelper extends net.minecraft.block.state.BlockPistonStructureHelper
{
	...
	public BlockPistonStructureHelper(World world, BlockPos pos, EnumFacing pistonFacing, boolean extending)
	{
	...
	private boolean addBlockLine(BlockPos origin, EnumFacing direction)
	{
		...
		else if (!BlockPistonBase.canPush(iblockstate, this.world, origin, this.moveDirection, false, direction))
		{
			return true;
		}
